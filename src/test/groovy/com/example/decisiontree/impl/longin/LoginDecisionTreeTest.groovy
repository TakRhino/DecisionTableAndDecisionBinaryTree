package com.example.decisiontree.impl.longin
...
class LoginDecisionTreeTest extends Specification {
    ...
    def resolveTest() {
        given:
        def decisionTree = new LoginDecisionTree()
        ...
        when:
        def actual = decisionTree.resolve(parameters)
