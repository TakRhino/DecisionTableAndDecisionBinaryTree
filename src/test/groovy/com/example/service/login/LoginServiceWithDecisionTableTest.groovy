...
import com.example.decisiontable.impl.login.LoginDecisionTable
...
class LoginServiceWithDecisionTableTest extends Specification {
    ...
    @Shared
    def service = new LoginServiceWithDecisionTable(new LoginDecisionTable(), repository)
