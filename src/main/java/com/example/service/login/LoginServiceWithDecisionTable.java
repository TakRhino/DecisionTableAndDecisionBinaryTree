...
import com.example.decisiontable.impl.login.*;
...
/**
 * This class is example of using Decision Table
 */
public class LoginServiceWithDecisionTable {
    private final LoginDecisionTable loginDecisionTable;
    private final UserAccountRepositoryMock userAccountRepository;

    public LoginServiceWithDecisionTable(LoginDecisionTable loginDecisionTable, UserAccountRepositoryMock userAccountRepository) {
        this.loginDecisionTable = loginDecisionTable;
    ...
    protected LoginResult checkAdminAccount(boolean existingId, int pin, String status, Set<String> roles) {
        return ((LoginResult) loginDecisionTable.resolve(
